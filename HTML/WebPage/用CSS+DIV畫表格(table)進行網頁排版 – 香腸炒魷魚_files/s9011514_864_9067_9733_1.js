(function(window, undefined) {
    ...
    var scriptId = "s9011514_864_9067_9733_1_script";
    ...
    // player parameters
        ...
        volume = 0.0,
        adviewerArg = "&channelid=9733&wid=864,17,24&PubID=lRhVRlJvEHEX",
        volume_on_by_default = false,
        auto_start = false,
        play_only_in_view_port = false;
    
    var pub = 'lRhVRlJvEHEX'; var cid = '9733'; var wid = '864,17,24'; ;
    ...
    _s.response[id] = null;
    // ask for an ad
    _s.load(http + "adsense.scupio.com/ADPInline/ADViewer.aspx?sv=1,950,390,2" + adviewerArg + "&u=" + encodeURIComponent(location.href) + "&ref=" + encodeURIComponent(document.referrer) + "&oid=" + id, "script", true);
