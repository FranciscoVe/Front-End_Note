var pu = "//img.scupio.com/ad/adpic/";
var vpu = (document.location.protocol == "https:" ? "https://img.scupio.com/ad/adpic/" : "http://img.scupio.com/ad/adpic/");
...
function redirect(adNo) {
    var ades = cu + ad[adNo] + up + '&en23=' + en23 + '&en24=' + en24 + '&clickrange=pic&redirect=2&rand=' + Math.random();
    go(ades);
}


function flashclick(adNo) {
    var ades = cu + ad[adNo] + up + '&en23=' + en23 + '&en24=' + en24 + '&clickrange=pic&redirect=0&rand=' + Math.random();
    includejs(ades);
}

function playvideo(adNo) {
    if (adNo >= 0) {
        var ades = cu + ad[adNo] + up + '&en23=' + en23 + '&en24=' + en24 + '&clickrange=video&redirect=0&rand=' + Math.random();
        includejs(ades);
        isFirstPlay = false;
    }
}
    ...
    if (IsSetSrc[adNo] == 0) {
        ...
        if (isFlash == 0)
            ...
            switch (isFlash) {
                ...
                case 4: // new video ad
//                    var videopath = vpu + src[adNo];
//                    flashVars = 'vsource=' + videopath + '&ct1=javascript:swfclick(' + adNo + ')' + '&ct2=javascript:playvideo(' + adNo + ')' + '&ct3=javascript:redirect(' + adNo + ')';
//                    isrc = player;
//
